...
HOOK_POST_DELAY     = 0.12        # 合わせ後 UI 出現待機
VERIFY_TIMEOUT      = 0.8         # ミニゲームUI出現確認のタイムアウト
...
# ステップ報酬（負側をやや強化）
RL_REWARD_ALIVE = 0.004
RL_REWARD_CENTER_SHAPE = 0.09
RL_REWARD_IN_BAR = 0.05
RL_REWARD_OUTSIDE_SCALE = 0.22
RL_REWARD_OUTSIDE_FLAT = 0.05
RL_REWARD_IMPROVE_GAIN = 0.012
RL_REWARD_RECAPTURE = 0.18
RL_REWARD_LOSE_BAR = 0.32
RL_REWARD_PROGRESS_GAIN = 0.32
RL_REWARD_ACTION_PENALTY = 0.50
