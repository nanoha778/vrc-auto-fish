...
# ステップ報酬（v2）
RL_REWARD_ALIVE = 0.01
RL_REWARD_CENTER_SHAPE = 0.10
RL_REWARD_IN_BAR = 0.03
RL_REWARD_OUTSIDE_SCALE = 0.08
RL_REWARD_IMPROVE_GAIN = 0.01
RL_REWARD_PROGRESS_GAIN = 0.25
RL_REWARD_ACTION_PENALTY = 0.8
