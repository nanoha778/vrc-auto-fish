...
ADAPTIVE_PD_SUCCESS_BONUS = 0.0
ADAPTIVE_PD_FAIL_PENALTY = 0.0
ADAPTIVE_PD_REWARD_MODE = "linear"
ADAPTIVE_PD_INVERSE_EPS = 0.20
ADAPTIVE_PD_INVERSE_CLIP = 3.0
ADAPTIVE_PD_ACTION_CHANGE_PENALTY = 0.0
ADAPTIVE_PD_SCALE_DEVIATION_PENALTY = 0.0
